#!/usr/bin/env python3
"""
Bot - Customer Support with Forum Topics + Auto-Reply
...
welcome_message = (
    ...
    "🎓 Paid courses & batches available\n\n"
    
    "📢 Details yahan dekhe:\n"
    "https://t.me/+mq-f6PVnTsJmODNh\n\n"
    
    "💳 Payment: Amazon e-Voucher (batch price ke according)\n\n"
    
    "📚 Payment ke baad course mil jayega\n\n"
    
    "⚠️ Bot ko block mat kare warna reply nahi milega\n\n"
    
    "👉 Abhi apna message bheje"
)
