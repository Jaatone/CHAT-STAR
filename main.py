...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_message = (
        "👋 <b>Welcome / नमस्ते!</b>\n\n"
        "🇬🇧 Please send your message or query here. Our team will reply soon.\n"
        "⚠️ <i>Note: Please do not block or ban this bot.</i>\n\n"
        "🇮🇳 कृपया अपना प्रश्न या समस्या यहाँ भेजें। हमारी टीम जल्द ही उत्तर देगी।\n"
        "⚠️ <i>नोट: कृपया इस बॉट को ब्लॉक या बैन न करें।</i>"
    )
