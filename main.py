...
SUPPORT_GROUP_ID = int(os.getenv("SUPPORT_GROUP_ID", "-1003803623115")) # Default value added if not set
...
async def delete_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not update.message.reply_to_message:
        await update.message.reply_text("Reply to message you want to delete.")
        return
    ...
    try:
        ...
        # delete from user chat if forwarded
...
def run_health_server():
    # Koyeb assigns a PORT dynamically, default to 8000 if not found
